...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://localhost:9000/workstation/mvc/">MVC Framework by : Shahali</a>
        </div>
        <!-- Top Menu Items -->
            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li class="active">
                    ...
                    <ul id="post" class="collapse in">
                        <li><a href="addCategory">Add Post</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                    ...
                    <form action="http://localhost:9000/workstation/mvc/Category/insertCategory" method="post">
                        <div class="form-group">
                            <label for="name">Category Name <?php if(isset($Msg)){echo $Msg;}?></label>
