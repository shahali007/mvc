...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="home.php">MVC Framework by : Shahali</a>
        </div>
        <!-- Top Menu Items -->
    ...
    <ul class="nav navbar-nav side-nav">
        ...
        <li class="active">
            ...
            <ul id="category" class="collapse in">
                <li><a href="http://localhost:9000/workstation/mvc/Index/addCategory">Add Category</a></li>
...
<nav class="navbar navbar-inverse navbar-static-top" style="margin-bottom: 0;">
    <p class="text-center text-muted">
        <br>
        &copy <?php echo date("Y"); ?> <a href="http://www.shahali.me/">Shahali Bogdadi.</a> All rights reserved.
    </p>
</nav>
